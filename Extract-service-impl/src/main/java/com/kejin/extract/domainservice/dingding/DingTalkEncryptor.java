...
import com.kejin.extract.common.utils.RandomUtil;
...
public class DingTalkEncryptor {
    ...
    public Map<String,String> getEncryptedMap(String plaintext, Long timeStamp, String nonce) throws DingTalkEncryptException {
        ...
        // 加密
        String encrypt = encrypt(RandomUtil.getRandomStr(RANDOM_LENGTH), plaintext);
    ...
    private String decrypt(String text) throws DingTalkEncryptException {
        ...
        try {
            // 设置解密模式为AES的CBC模式
            Cipher cipher = Cipher.getInstance("AES/CBC/NoPadding");
            SecretKeySpec keySpec = new SecretKeySpec(Arrays.copyOfRange(aesKey, 0, 16), "AES");
...
//            IvParameterSpec iv = new IvParameterSpec("abcdefghijklmnop".getBytes());
        ...
        try {
            ...
            int plainTextLegth = Utils.ByteArrayToInt(networkOrder);
            byte[] b = corpId.getBytes();
