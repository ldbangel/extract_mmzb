...
public class AesEncodeUtil {
	private static byte[] aesKey = "UnTCdrcuISJ33L4yeRSnovaRhVBimgKHGs0IIMGeein".getBytes();
	//初始向量
	...
	public static String encrypt(String cleartext) {
		...
		try {
			IvParameterSpec zeroIv = new IvParameterSpec(aesKey,0,16);
	...
	public static void main(String[] args) throws Exception {
		...
		/*String content = "dfsdifuisdfji15648";
		// 加密
		...
		System.out.println(encrypt("ldzESazDyPD2i5329M+OUbBbw1ULB+7TTDYZ59fhkgY="));
