...
public class ExtractDUserDataDaemon extends AbstractExtract implements DaemonTask {
	@Resource(name="memberInfoConstruct")
	private MemberInfoConstruct memberInfoConstruct;
	
	public String HANDLE_DATA = "d_user";
	...
	public int construct(Date recordBeginDatetime, Date recordEndDatetime) {
		return memberInfoConstruct.constructUser(recordBeginDatetime,recordEndDatetime);
	}
}
