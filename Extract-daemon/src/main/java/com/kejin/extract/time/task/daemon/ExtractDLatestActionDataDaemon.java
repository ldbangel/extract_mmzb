...
public class ExtractDLatestActionDataDaemon extends AbstractExtract implements DaemonTask {
	
	@Resource(name="latestActionInfoConstruct")
	private LatestActionInfoConstruct latestActionInfoConstruct;

	
	public String HANDLE_DATA = "d_latest_action";
	...
	public ExtractDLatestActionDataDaemon(){
	...
	public int  construct(Date recordBeginDatetime, Date recordEndDatetime) {
		return latestActionInfoConstruct.constructLatestAction(recordBeginDatetime, recordEndDatetime);
	}
